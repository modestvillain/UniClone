...
//			//score += 4*(enemyTM.totalMinDistanceToDesiredBases(weightForCloseToBases) - TM.totalMinDistanceToDesiredBases(weightForCloseToBases));
//			score -=TM.totalMinDistanceToDesiredBases(weightForCloseToBases);
